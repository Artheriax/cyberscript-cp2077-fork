...
function makeNativeSettings()
        ...
        -- Diagnostic: force-log so we can verify makeNativeSettings actually ran.
        -- This uses force=true so it appears in cyberscript.log even with debugLog off.
        logme(1, "[Cyberscript Init] makeNativeSettings() called — building settings tabs", true)
